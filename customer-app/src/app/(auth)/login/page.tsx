      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#0E0C09]">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 pb-16">
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <span className="text-[#F5EDD8] font-display font-semibold text-2xl" style={{ fontFamily: "var(--font-fraunces)" }}>
              Crave<span className="text-[#E8A830]">Cart</span>
            </span>
          </div>
          <h2 className="text-[#F5EDD8] font-display font-semibold text-4xl leading-tight" style={{ fontFamily: "var(--font-fraunces)" }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[#0C0B09]">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="text-[#F5EDD8] font-display font-semibold text-xl" style={{ fontFamily: "var(--font-fraunces)" }}>
              Crave<span className="text-[#E8A830]">Cart</span>
            </span>
          </div>
          <h1 className="text-[#F5EDD8] font-display font-semibold text-3xl mb-2" style={{ fontFamily: "var(--font-fraunces)" }}>Welcome back</h1>
