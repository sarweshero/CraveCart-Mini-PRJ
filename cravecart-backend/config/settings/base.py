...
CRAVECART_REFRESH_EXPIRY_DAYS = 30     # Refresh token: 30 days
...
MIN_ORDER_AMOUNT = 50          # ₹ minimum order value
PLATFORM_FEE = 5               # ₹ flat platform fee per order
DEFAULT_DELIVERY_FEE = 30      # ₹ fallback delivery fee
TAX_RATE = 0.05                # 5% GST

# Account soft-deletion: permanent delete scheduled N days after deactivation
